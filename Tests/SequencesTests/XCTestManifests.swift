...
extension IntersectionSequenceTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__IntersectionSequenceTests = [
        ("testIntersection1", testIntersection1),
        ("testIntersection2", testIntersection2),
        ("testIntersectionWhere", testIntersectionWhere),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(IntersectionSequenceTests.__allTests__IntersectionSequenceTests),
